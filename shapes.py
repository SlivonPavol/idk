...
def display_data(bpm, oxygen):
    ...
    disp.add_text("Beat_num", str(bpm), ((320/2)-50, 60), font=Beat_num_font, color=text_color)
    disp.add_text("Beat_text", "Bpm", (230, 110), font=Beat_text_font, color=text_color)
    disp.add_text("oxygen_num", str(oxygen), ((320/2)-50, 190), font=Beat_num_font, color=text_color)
...
if __name__ == "__main__":
    # Here you can call your display_data function or any other functions you want to execute when running the script directly.
    # For example:
    bpm = 80
    oxygen = 98
    display_data(bpm, oxygen)
